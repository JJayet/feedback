...
<div class="root">
  <p class="emoji">😎</p>
  <p>
    Welcome to Bookstall, a sample SvelteKit application built to illustrate the
    usage of ✨
    <a
    ...
    >.
    <br />
    No REST API routes are being used white you're managing books, authors and stores
